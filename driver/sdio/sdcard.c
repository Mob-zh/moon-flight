...
sd_error_status_type sd_irq_service(void)
{
    ...
    /* disable interrupt */
    sdio_interrupt_enable(SDIOx, (SDIO_DTFAIL_INT | SDIO_DTTIMEOUT_INT | SDIO_DTCMP_INT | SDIO_TXBUFH_INT | SDIO_RXBUFH_INT | SDIO_TXERRU_INT | SDIO_RXERRO_INT | SDIO_SBITERR_INT), FALSE);
    return (SD_OK);
}

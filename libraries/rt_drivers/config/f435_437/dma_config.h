...
#define UART1_RX_DMA_IRQHandler  DMA1_Channel7_IRQHandler
#define UART1_RX_DMA_CLOCK       CRM_DMA1_PERIPH_CLOCK
#define UART1_RX_DMA_CHANNEL     DMA1_CHANNEL7
#define UART1_RX_DMA_IRQ         DMA1_Channel7_IRQn
#define UART1_RX_DMA_MUX_CHANNEL DMA1MUX_CHANNEL7

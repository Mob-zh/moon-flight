...
/**
 * @brief  init dma1 channel1 for "tmr3_ch2"
 * @param  none
 * @retval none
 */
void wk_dma1_channel1_init(void)
{
    ...
    dmamux_init(DMA1MUX_CHANNEL1, DMAMUX_DMAREQ_ID_TMR3_CH2);
...
/**
 * @brief  init dma1 channel2 for "tmr3_ch1"
 * @param  none
 * @retval none
 */
void wk_dma1_channel2_init(void)
{
    ...
    /* dmamux function enable */
    dmamux_enable(DMA1, TRUE);
    dmamux_init(DMA1MUX_CHANNEL2, DMAMUX_DMAREQ_ID_TMR3_CH1);
...
/**
 * @brief  init dma1 channel3 for "tmr4_ch1"
 * @param  none
 * @retval none
 */
void wk_dma1_channel3_init(void)
{
    ...
    /* dmamux function enable */
    dmamux_enable(DMA1, TRUE);
    dmamux_init(DMA1MUX_CHANNEL3, DMAMUX_DMAREQ_ID_TMR4_CH1);
...
/**
 * @brief  init dma1 channel4 for "tmr4_ch2"
 * @param  none
 * @retval none
 */
void wk_dma1_channel4_init(void)
{
    ...
    /* dmamux function enable */
    dmamux_enable(DMA1, TRUE);
    dmamux_init(DMA1MUX_CHANNEL4, DMAMUX_DMAREQ_ID_TMR4_CH2);
